"""Training LightGBM USDJPY M1 — Phase 6 forex.

Output :
- bot_v2/ml_model_USDJPY.pkl
- bot_v2/ml_features_USDJPY.json
- ml_metrics_USDJPY.txt
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_USDJPY_4ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_USDJPY.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_USDJPY.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_USDJPY.txt")
...
def main():
    ...
    df = df[df["instrument"] == "USDJPY"].copy()
    print(f"  {len(df)} lignes USDJPY")
