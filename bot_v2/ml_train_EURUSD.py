"""Training LightGBM EURUSD M1 — Phase 6 forex.

Output :
- bot_v2/ml_model_EURUSD.pkl
- bot_v2/ml_features_EURUSD.json
- ml_metrics_EURUSD.txt
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_EURUSD_4ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_EURUSD.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_EURUSD.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_EURUSD.txt")
...
def main():
    ...
    df = df[df["instrument"] == "EURUSD"].copy()
    print(f"  {len(df)} lignes EURUSD")
