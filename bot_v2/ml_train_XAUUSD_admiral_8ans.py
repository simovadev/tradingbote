"""Training LightGBM XAUUSD M1 sur 8 ans Admiral.

Dataset : data/ml_dataset_XAUUSD_admiral_8ans.parquet (3487 lignes)
Output :
- bot_v2/ml_model_XAUUSD_admiral.pkl
- bot_v2/ml_features_XAUUSD_admiral.json
- ml_metrics_XAUUSD_admiral.txt

Comparaison cible (modele 4 ans Duka) :
  TRAIN 1302 trades : seuil 0.55 -> WR 91.9% (AUC 0.928)
  VAL    434 trades : seuil 0.55 -> WR 61.8% (AUC 0.786)
  TEST   434 trades : seuil 0.55 -> WR 63.9% (AUC 0.789)
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_XAUUSD_admiral_8ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_XAUUSD_admiral.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_XAUUSD_admiral.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_XAUUSD_admiral.txt")
