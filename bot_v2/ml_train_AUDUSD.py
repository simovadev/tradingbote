"""Training LightGBM AUDUSD M1 — Phase 6 forex.

Output :
- bot_v2/ml_model_AUDUSD.pkl
- bot_v2/ml_features_AUDUSD.json
- ml_metrics_AUDUSD.txt
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_AUDUSD_4ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_AUDUSD.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_AUDUSD.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_AUDUSD.txt")
...
def main():
    ...
    df = df[df["instrument"] == "AUDUSD"].copy()
    print(f"  {len(df)} lignes AUDUSD")
