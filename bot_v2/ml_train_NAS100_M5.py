"""Training LightGBM NAS100 M5 — meme methodologie que ml_train.py.

Output :
- bot_v2/ml_model_NAS100_M5.pkl
- bot_v2/ml_features_NAS100_M5.json
- ml_metrics_NAS100_M5.txt
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_M5.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_NAS100_M5.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_NAS100_M5.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_NAS100_M5.txt")
...
def main():
    ...
    # Garde NAS100 uniquement (sécurité si dataset contient autres actifs)
    df = df[df["instrument"] == "NAS100"].copy()
    print(f"  {len(df)} lignes NAS100 M5")
