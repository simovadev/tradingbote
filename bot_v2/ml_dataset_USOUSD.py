"""Build dataset ML USOUSD M1 — Phase 4, meme methodologie que GER40 (4 ans).

Decision user 2026-05-17 : WTI Crude (Vantage USOUSD), 4 ans pour stabilite modele.
"""
...
def main():
    ...
    print(f"Actif : USOUSD (Phase 4 - TF M1)")
