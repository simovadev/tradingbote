"""Build dataset ML SP500 V3.5 - Admiral 8 ans, filtres relaches.
...
def main():
    ...
    output_path = Path(f"{ROOT}/data/ml_dataset_SP500_admiral_8ans_V3_5.parquet")
    build_dataset(
