"""Build dataset ML EURUSD V3.5 - Admiral 8 ans, filtres relaches.
...
def main():
    ...
    print(f"=== ML DATASET EURUSD V3.5 ===")
    ...
    output_path = Path(f"{ROOT}/data/ml_dataset_EURUSD_admiral_8ans_V3_5.parquet")
    build_dataset(
