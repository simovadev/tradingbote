"""Train LightGBM FRA40 V3.5 - Admiral 8 ans.
...
Output :
- bot_v2/ml_model_FRA40_admiral_v3_5.pkl
- ml_metrics_FRA40_admiral_v3_5.txt
"""
...
DATASET_PATH = Path(f"{ROOT}/data/ml_dataset_FRA40_admiral_8ans_V3_5.parquet")
MODEL_PATH = Path(f"{ROOT}/bot_v2/ml_model_FRA40_admiral_v3_5.pkl")
FEATURES_PATH = Path(f"{ROOT}/bot_v2/ml_features_FRA40_admiral_v3_5.json")
METRICS_PATH = Path(f"{ROOT}/ml_metrics_FRA40_admiral_v3_5.txt")
