"""Training LightGBM USDCAD M1 - Phase 4 (user 2026-05-18)."""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_USDCAD_4ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_USDCAD.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_USDCAD.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_USDCAD.txt")
...
def main():
    ...
    FEATURES_PATH.write_text(json.dumps({
        "features": feat_cols, "categorical": cat_cols,
    }, indent=2))
