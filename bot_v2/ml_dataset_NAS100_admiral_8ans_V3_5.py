"""Build dataset ML NAS100 V3.5 - Admiral 8 ans, filtres relaches.
...
def main():
    ...
    print(f"=== ML DATASET NAS100 V3.5 ===")
    ...
    output_path = Path(f"{ROOT}/data/ml_dataset_NAS100_admiral_8ans_V3_5.parquet")
    build_dataset(
