"""Training LightGBM GBPUSD M1 — Phase 6 forex.

Output :
- bot_v2/ml_model_GBPUSD.pkl
- bot_v2/ml_features_GBPUSD.json
- ml_metrics_GBPUSD.txt
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_GBPUSD_4ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_GBPUSD.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_GBPUSD.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_GBPUSD.txt")
...
def main():
    ...
    df = df[df["instrument"] == "GBPUSD"].copy()
    print(f"  {len(df)} lignes GBPUSD")
