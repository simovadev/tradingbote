"""Optimisation du seuil ML par actif - V10.

Pour chaque actif :
1. Charge le dataset V10 (data/ml_dataset_{asset}_vantage_v10.parquet).
2. Filtre la periode OOS (2025-11-22 -> 2026-05-21, jamais vue en training).
3. Recalcule les probas du modele V10 sur l'OOS.
...
Usage : python tools/optimize_thresholds_v10.py
"""
...
# Periode OOS = jamais vue pendant le training V10
...
def analyse_asset(asset: str) -> dict | None:
    ds_path = ROOT / f"data/ml_dataset_{asset}_vantage_v10.parquet"
    model_path = ROOT / f"bot_v2/ml_model_{asset}_vantage_v10.pkl"
    feat_path = ROOT / f"bot_v2/ml_features_{asset}_vantage_v10.json"
...
def main():
    print("=" * 90)
    print("OPTIMISATION SEUIL ML V10 - OOS 6 mois (2025-11-22 -> 2026-05-21)")
    print("=" * 90)
    print()
    ...
    out_path = ROOT / "ml_thresholds_v10_optimal.json"
