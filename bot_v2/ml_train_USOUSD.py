"""Training LightGBM USOUSD M1 — Phase 4 (meme methodologie GER40 4 ans).

Output :
- bot_v2/ml_model_USOUSD.pkl
- bot_v2/ml_features_USOUSD.json
- ml_metrics_USOUSD.txt
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_USOUSD_4ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_USOUSD.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_USOUSD.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_USOUSD.txt")
...
def main():
    ...
    df = df[df["instrument"] == "USOUSD"].copy()
    print(f"  {len(df)} lignes USOUSD")
