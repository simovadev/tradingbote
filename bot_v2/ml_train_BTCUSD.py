"""Training LightGBM BTCUSD M1 — Phase 5 (meme methodologie GER40/NAS100 4 ans).

Output :
- bot_v2/ml_model_BTCUSD.pkl
- bot_v2/ml_features_BTCUSD.json
- ml_metrics_BTCUSD.txt
"""
...
DATASET_PATH = Path("c:/Users/Shadow/TradingBot/data/ml_dataset_BTCUSD_4ans.parquet")
MODEL_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_model_BTCUSD.pkl")
FEATURES_PATH = Path("c:/Users/Shadow/TradingBot/bot_v2/ml_features_BTCUSD.json")
METRICS_PATH = Path("c:/Users/Shadow/TradingBot/ml_metrics_BTCUSD.txt")
...
def main():
    ...
    df = df[df["instrument"] == "BTCUSD"].copy()
    print(f"  {len(df)} lignes BTCUSD")
